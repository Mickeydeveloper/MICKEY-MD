            ...
            message: {
                ...
                interactiveMessage: proto.Message.InteractiveMessage.create({
                    ...
                    header: proto.Message.InteractiveMessage.Header.create({
                        ...(await prepareWAMessageMedia({ image: { url: './assets/msela.jpg' } }, { upload: conn.waUploadToServer })),
                        title: null,
                        subtitle: null,
                    ...
                    nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.create({
                        buttons: [
                            ...
                            },
                            {
                                ...
                                "buttonParamsJson": JSON.stringify({
                                    "display_text": "OWNER 🌟",
                                    "url": "https://wa.me/message/255778018545"
                                })
                            },
                            {
                                "name": "cta_url",
...
handler.help = ['main'];
handler.tags = ['group'];
handler.command = ['main', 'help2', 'h', 'commands2'];
